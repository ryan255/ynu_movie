				...
				<div class="banner col-md-8">
					<section class="slider">
						<div class="flexslider">
							<ul class="slides">
								<c:forEach var="film" items="${filmOnline.list}">
									<li><img style="height: 350px;"
										src="resource/images/${film.f_cover_s}"
							...
							<li>选择电影：
								<form action="selectfilmByfilmName" method="Get">
									<select class="list_of_movies" name="f_name">
										<option value="">—— —— —— ——</option>
										<c:forEach var="film" items="${filmOnline.list}">
											<option value="${film.f_name}">${film.f_name}</option>
										</c:forEach>
									</select>
					...
					<c:forEach var="film" items="${filmOnline.list}">
						...
						<li>
							<form action="selectfilmByfilmName" method="Get">
								...
								<a href="selectfilmByfilmName?f_name=${film.f_name}"> <img style="height: 250px;"
									src="resource/images/${film.f_cover_s}" alt="">
								</a>
								...
								<div class="date-city">
									<h5>${film.f_time}</h5>
									<h6>${film.f_country}</h6>
									<input value="${film.f_name}" style="display:none" name="f_name" />
					...
					<div class="top-movies-in-india">
						...
						<c:forEach var="film" items="${filmOnline.list}">
							<ul class="mov_list">
								...
								<li>${film.f_click}</li>
								<li><a href="movie-single.html">${film.f_name}
										(3D) (${film.f_country})</a></li>
							</ul>
