    ...
    <div class="main-content">
                ...
                <div id="defaultmenu" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="w3_megamenu-fw">
                            <a href="movies.html">电影排期<b class="caret"></b></a>
                        </li>

                        <li class="w3_megamenu-fw">
                            <a href="activities.html">促销活动<b class="caret"></b></a>
                        </li>

                        <li class="w3_megamenu-fw">
                            <a href="message.html">电影影评<b class="caret"></b></a>
                        </li>
                    </ul>
                </div>
        ...
        <div class="review-slider col-md-12">
            <ul id="flexiselDemo1">
                <li>
                    <a href="movies,html">
                        <img src="resource/images/r1.jpg" alt="">
                    </a>
                ...
                <li>
                    <a href="movies,html">
                        <img src="resource/images/r2.jpg" alt="">
                    </a>
                    <div class="slide-title">
                        <h4>123</h4>
                    </div>
                ...
                <li>
                    <a href="movies,html">
                        <img src="resource/images/r3.jpg" alt="">
                    </a>
                    <div class="slide-title">
                        <h4>123</h4>
                    </div>
                ...
                <li>
                    <a href="movies,html">
                        <img src="resource/images/r4.jpg" alt="">
                    </a>
                    <div class="slide-title">
                        <h4>123</h4>
                    </div>
                ...
                <li>
                    <a href="movies,html">
                        <img src="resource/images/r5.jpg" alt="">
                    </a>
                    <div class="slide-title">
                        <h4>123</h4>
                    </div>
                ...
                <li>
                    <a href="movies,html">
                        <img src="resource/images/r6.jpg" alt="">
                    </a>
                    <div class="slide-title">
                        <h4>123</h4>
                    </div>
                            ...
                            <div class="resp-tabs-container">
                                    ...
                                    <ul class="tab_img">
                                        <li>
                                            <div class="view view-first">
                                                <a href="movie-select-show.html"> <img src="resource/images/pic-1.jpg" class="img-responsive" alt=""/></a>
                                                <div class="info1"> </div>
                                                <div class="mask">
                                                </div>
                                                <div class="tab_desc">
                                        ...
                                        <li>
                                            <div class="view view-first">
                                                <a href="movie-select-show.html"><img src="resource/images/pic-2.jpg" class="img-responsive" alt=""/></a>
                                                <div class="info1"> </div>
                                                <div class="mask">
                                                </div>
                                                <div class="tab_desc">
                                        ...
                                        <li>
                                            <div class="view view-first">
                                                <a href="movie-select-show.html"><img src="resource/images/pic-10.jpg" class="img-responsive" alt=""/></a>
                                                <div class="mask">
                                                    <div class="info1"> </div>
                                                </div>
                                                <div class="tab_desc">
                                ...
                                <div class="tab-1 resp-tab-content" aria-labelledby="tab_item-1">
                                    <ul class="tab_img">
                                        <li>
                                            <div class="view view-first">
                                                <a href="movie-select-show.html"><img src="resource/images/pic-8.jpg" class="img-responsive" alt=""/></a>
                                                <div class="mask">
                                                    <div class="info1"> </div>
                                                </div>
                                                <div class="tab_desc">
                                        ...
                                        <li>
                                            <div class="view view-first">
                                                <a href="movie-select-show.html"> <img src="resource/images/pic-3.jpg" class="img-responsive" alt=""/></a>
                                                <div class="mask">
                                                    <div class="info1"> </div>
                                                </div>
                                                <div class="tab_desc">
                                        ...
                                        <li class="last">
                                            <div class="view view-first">
                                                <a href="movie-select-show.html"><img src="resource/images/pic-9.jpg" class="img-responsive" alt=""/></a>
                                                <div class="mask">
                                                    <div class="info1"> </div>
                                                </div>
                                                <div class="tab_desc">
                                ...
                                <div class="tab-1 resp-tab-content" aria-labelledby="tab_item-2">
                                    <ul class="tab_img">
                                        <li>
                                            <div class="view view-first">
                                                <a href="movie-select-show.html"> <img src="resource/images/pic-4.jpg" class="img-responsive" alt=""/></a>
                                                <div class="mask">
                                                    <div class="info1"> </div>
                                                </div>
                                                <div class="tab_desc">
                                        ...
                                        <li>
                                            <div class="view view-first">
                                                <a href="movie-select-show.html"> <img src="resource/images/pic-12.jpg" class="img-responsive" alt=""/></a>
                                                <div class="mask">
                                                    <div class="info1"> </div>
                                                </div>
                                                <div class="tab_desc">
                                        ...
                                        <li class="last">
                                            <div class="view view-first">
                                                <a href="movie-select-show.html"><img src="resource/images/pic-5.jpg" class="img-responsive" alt=""/></a>
                                                <div class="mask">
                                                    <div class="info1"> </div>
                                                </div>
                                                <div class="tab_desc">
                                ...
                                <div class="tab-1 resp-tab-content" aria-labelledby="tab_item-3">
                                    <ul class="tab_img">
                                        <li>
                                            <div class="view view-first">
                                                <a href="movie-select-show.html"> <img src="resource/images/pic-6.jpg" class="img-responsive" alt=""/></a>
                                                <div class="mask">
                                                    <div class="info1"> </div>
                                                </div>
                                                <div class="tab_desc">
